 ...
 */
 ...
 /** A comparator which imposes objects' <i>natural ordering</i>.  This comparator's {@link #compare(Object, Object)} method
   ...
   */
public class GenericComparator<K extends Comparable<?>> implements java.util.Comparator<K> {
	
	protected GenericComparator() {}
	...
	/** Compares its two arguments for order.
	  ...
	  * @since 1.0
	  */
	public int compare(K o1, K o2) { return ((java.lang.Comparable)o1).compareTo(o2); }
        ...
        /** Indicates whether some other object is "equal to" this Comparator.
          ...
          * @since 1.0
          */          
	public boolean equals(Object obj) { return (obj == GenericComparator.instance); }
